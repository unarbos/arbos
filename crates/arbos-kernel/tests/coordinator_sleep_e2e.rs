...
fn a_coordinators_attached_command_yields_when_a_workers_report_lands() {
    let replies = concat!(
        ...
        // a long command that is not a sleep (a poll loop), which yields.
        ...
        "{\"agent\":\"root\",\"content\":\"polling\",\"calls\":[{\"name\":\"bash\",\"arguments\":{\"command\":\"for i in $(seq 1 60); do echo poll $i; sleep 1; done\",\"description\":\"Poll\",\"wait_ms\":120000}}]}\n",
