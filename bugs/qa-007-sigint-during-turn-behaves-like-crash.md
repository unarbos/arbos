...
- Desktop scenarios `desktop-rapid-session-switch` and `desktop-kill-kernel-under-ui` (2026-09-13 01:26Z): the harness SIGINTs the desktop's detached kernel a few seconds after a prompt, mid-turn; same three findings. Fix is #12.
