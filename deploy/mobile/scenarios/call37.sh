...
Y=$(xcrun simctl io $U screenshot /tmp/r.png >/dev/null 2>&1; python3 ~/find_row.py /tmp/r.png phone); idb ui tap 120 $Y --udid $U; sleep 3; shot 70-phone-chat-one-surface
