...
for i in $(seq 1 12); do idb ui swipe 196 250 196 800 --duration 0.08 --udid $U; done; sleep 1.2
E=$(ypos earlier); echo "earlier again at $E"; idb ui tap $E --udid $U; sleep 2.5; shot 32-after-page-2
for i in $(seq 1 30); do idb ui swipe 196 800 196 200 --duration 0.08 --udid $U; done; sleep 1.5; shot 33-after-30-flings-down
