...
# Store second reader: FAULT at 2026-09-18T14:12:21Z from qa-vm2

1 file(s) the mirror accepted are not here.

This client saw 521 file(s) in scope; the mirror's last accepted view (`store-docs` at `7020cead8026`, 9 min old) has 521. `docs/`: present; `notes.md`: present. Store root listed: `archived.md artifacts docs inbox internal media notes.md `.
