...
- **Cycle 27 (opened 03:20 UTC)**: (1) `rows_under` must agree with what draws — the P_EDIT fold; (2) d11 on the long-form place with a clean kernel, and the Cursor side of it; (3) themes light/dark side by side (owed since cycle 11); (4) if Jacob says yes to worker tabs, that is the headline instead.
