> **RECOVERED from the repository mirror — believed complete.** Source: `docs/design/filesystem-state-design.md` in `unarbos/arbos` at commit `9b49a65` (2026-09-15 17:49 UTC). 78,448 bytes there against 78,447 in the store's last listing, a one-byte difference, so this is effectively the original.
>
